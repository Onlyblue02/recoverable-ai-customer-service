...
class AgentReasonCode(StrEnum):
    ...
    RESPONSE_DRAFT_ACCEPTED = "RESPONSE_DRAFT_ACCEPTED"
    RESPONSE_MODEL_INVALID = "RESPONSE_MODEL_INVALID"
    RESPONSE_MODEL_UNAVAILABLE = "RESPONSE_MODEL_UNAVAILABLE"
    RESPONSE_EVIDENCE_INVALID = "RESPONSE_EVIDENCE_INVALID"
    RESPONSE_GATE_ALLOWED = "RESPONSE_GATE_ALLOWED"
    RESPONSE_GATE_REWRITTEN = "RESPONSE_GATE_REWRITTEN"
    RESPONSE_GATE_CLARIFY = "RESPONSE_GATE_CLARIFY"
    RESPONSE_GATE_ESCALATE = "RESPONSE_GATE_ESCALATE"
